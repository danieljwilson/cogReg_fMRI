function foodreg_m1_preference_analyze2(subjNameList, preproc_version)
...
% convert to TSV from Matlab
    ...
    for session=1:length(files) % this loops over sessions
		...
		%predefine modulating parameters (preference ratings) for three
		%trial types
        ...
        ons_modulate{1,session}{1}.name='Preference';   % {1} specifies the first modulator (and only in this case)

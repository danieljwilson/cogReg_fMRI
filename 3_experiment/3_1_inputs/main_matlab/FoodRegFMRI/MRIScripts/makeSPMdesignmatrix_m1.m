function SPM = makeSPMdesignmatrix_m1(filestr,ons,ons_name, ons_duration, ons_modulate, mov_reg)
...
%===========================================================================
	...
	for i=1:NumSessions
    	...
    	for f=1:length(files)
    		SPM.xY.P	= cat(1,SPM.xY.P, [Directory files(f).name]);
    	end
    ...
    for i=1:NumSessions
		SPM.Sess(i).C.C = mov_reg{i};		% [n x c double ] regressors
